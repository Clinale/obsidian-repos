...
![1](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/1.png)
...
![2](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/2.png)
...
![3](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/3.png)

diff一下补丁和源文件：（这里采用sublime的FileDiffs插件来进行diff对比）

![4](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/4.png)
...
![5](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/5.png)

**第17行** (上图)的 **parse_str** 引起了我的兴趣，看一下这一小段代码做了些什么（下图第4行处）：

![6](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/6.png)
...
![8](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/8.png)
...
![14](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/14.png)

看看源代码里是怎么处理这个的 **$rnd_cookieEncode** 变量的。

![15](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/15.png)
...
![9](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/9.png)
...
![10](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/10.png)
...
![11](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/11.png)
...
![13](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/13.png)
...
![16](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/16.png)

**demo漏洞修复**

![17](CTF%20总结/PHP-Audit-Labs/Part1/Day7/files/17.png)
