...
![1](CTF%20总结/PHP-Audit-Labs/Part1/Day17/files/1.png)
...
![2](CTF%20总结/PHP-Audit-Labs/Part1/Day17/files/2.png)
...
![3](CTF%20总结/PHP-Audit-Labs/Part1/Day17/files/3.png)
...
![4](CTF%20总结/PHP-Audit-Labs/Part1/Day17/files/4.png)
...
![5](CTF%20总结/PHP-Audit-Labs/Part1/Day17/files/5.png)
...
![6](CTF%20总结/PHP-Audit-Labs/Part1/Day17/files/6.png)

## 漏洞验证

所以最后两个payload都可以解出题目。

![7](CTF%20总结/PHP-Audit-Labs/Part1/Day17/files/7.png)

![8](CTF%20总结/PHP-Audit-Labs/Part1/Day17/files/8.png)

## 修复建议

建议在使用 **md5** 函数的时候，不要将 **$raw_output** 字段设置为**true** 。

![9](CTF%20总结/PHP-Audit-Labs/Part1/Day17/files/9.png)
